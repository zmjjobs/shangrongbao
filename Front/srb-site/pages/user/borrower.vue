...
export default {
  ...
  methods: {
    ...
    initSelected() {
      //学历列表
      this.$axios
        .$get('/api/core/dict/listByDictCode/education')
        .then((response) => {
      ...
      //行业列表
      this.$axios
        .$get('/api/core/dict/listByDictCode/industry')
        .then((response) => {
      ...
      //收入列表
      this.$axios
        .$get('/api/core/dict/listByDictCode/income')
        .then((response) => {
      ...
      //还款来源列表
      this.$axios
        .$get('/api/core/dict/listByDictCode/returnSource')
        .then((response) => {
      ...
      //联系人关系列表
      this.$axios
        .$get('/api/core/dict/listByDictCode/relation')
        .then((response) => {
